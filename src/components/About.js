    ...
    <div className="my-20 xl:mx-28 lg:mx-20 sm:mx-12 mx-4">
      <div className="flex gap-8 lg:flex-row flex-col">
        ...
        <div className="lg:w-[40%] w-full flex flex-col items-start gap-y-4">
          ...
          <h1 className="text-[#00095E] xl:text-[55px] lg:text-[50px] sm:text-[40px] text-[2rem] leading-snug block font-bold ">
            Get ready for real <br /> time adventure{" "}
          </h1>

          <p className="text-[#677F8B] font-normal w-full sm:w-2/3 lg:w-full lg:text-[20px] sm:text-[15px] text-[1rem] leading-9">
            Let’s start your journey with us, your dream will come true. We
            provide comfortable and safe journey to our travellers. Enjoy the
            journey with us from Hyderabad to Srisailam . Book your trip and
            Enjoy the moment .
          </p>
